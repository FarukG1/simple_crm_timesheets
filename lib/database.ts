...
export async function get(table: TableType) {
...
export async function create(data: Customer | Caregiver | Appointment) {
  const client = await clientPromise;
  try {
    const db = client.db("swe-projekt");
...
export async function update(data: Customer | Caregiver | Appointment) {
  const client = await clientPromise;
  try {
    const db = client.db("swe-projekt");
...
export async function remove(data: Customer | Caregiver | Appointment) {
  const client = await clientPromise;
  try {
    const db = client.db("swe-projekt");
